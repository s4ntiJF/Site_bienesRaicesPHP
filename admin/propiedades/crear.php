<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $titulo = mysqli_real_escape_string( $baseDatos, $_POST['titulo'] );
        ...
        $wc = mysqli_real_escape_string( $baseDatos, $_POST['wc'] );
        $estacionamiento = mysqli_real_escape_string( $baseDatos, $_POST['estacionamiento'] );
        ...
        if( empty($errores)){
            ...
            // Subir la imagen
            move_uploaded_file( $imagen['tmp-name'], $carpetaImagenes . $nombreImagen );

            // Insertar en la base de datos
            $query = "INSERT INTO propiedades ( titulo, precio, imagen, descripcion, habitaciones, wc, estacionamiento, 
            creado, vendedorId ) VALUES ( '$titulo', '$precio', '$nombreImagen', '$descripcion', '$habitaciones', '$wc', '$estacionamiento',
            '$creado', '$vendedorId' ) ";
    ...
    <main class="contenedor seccion">
        ...
        <form class="formulario" method="POST" action="/admin/propiedades/crear.php" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <input type="number" id="estacionamiento" placeholder="Ej: 3" min="1" max="9" name="estacionamiento" value="<?php 
